...
import ibge.DadosIbge;

/**
 * Município com dados estatísticos do IBGE.
 *
 * @criacao: Vovolinux
 * @data . : 28/06/2020
 * @projeto: Objetos genéricos para Java.
 */
public class MunicipioIbge extends Municipio {

    private DadosIbge dadosIbge = null;

    public DadosIbge getDadosIbge() {
        return dadosIbge;
    }

    public void setDadosIbge(DadosIbge dadosIbge) {
        this.dadosIbge = dadosIbge;
    }
